...
ap.add_argument("-p", "--prototxt", required = True,  help = "D:\class\python\realtime-object-detection-master\MobileNetSSD_deploy.prototxt.txt")
ap.add_argument("-m", "--model", required = True, help = "D:\class\python\realtime-object-detection-master\MobileNetSSD_deploy.caffemodel")
